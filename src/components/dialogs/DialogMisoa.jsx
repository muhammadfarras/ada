...
const DialogMisoa = ({ isOpen, handleClose }) => {
    ...
    return (
        <>
            <Dialog
                ...
                onClose={handleClose}
            >
                <DialogTitle>Misoa Goreng / Panggang</DialogTitle>
                <DialogContent>
                    <DialogContentText>
                    </DialogContentText>
                    <MenuMenu />
...
const MenuMenu = () => {
    ...
    const datas = [
        createData("Misoa Paket Minimalis", "Rp5.000,00", "2 potong + saus sambal"),
        createData("Misoa Paket Bersama", "Rp30.000,00", "1 loyang + saus sambal")
    ]
