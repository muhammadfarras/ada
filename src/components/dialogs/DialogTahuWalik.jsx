...
const DialogTahuWalik = ({ isOpen, handleClose }) => {
    ...
    return (
        <>
            <Dialog
                ...
                onClose={handleClose}
            >
                <DialogTitle>Tahu Walik</DialogTitle>
                <DialogContent>
                    <DialogContentText>
                    </DialogContentText>
                    <MenuMenu />
...
const MenuMenu = () => {
    ...
    const datas = [
        createData("Tahu Walik Paket 1", "Rp15.000,00", "10 walik + Kecap Sambal Pedas")
    ]
...
export default DialogTahuWalik